...
- 모델의 전체적인 구조는 Human-Object Proposal 부분이 제외된 <a href="https://arxiv.org/pdf/1702.05448.pdf">HO-RCNN (Chao et al., 2017)</a> 의 구조를 참고하였고 Subject와 Object 이미지를 위한 CNN는 따로 훈련된 ResNet-152를 사용하기로 했다.
